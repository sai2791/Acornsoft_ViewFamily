...
entry(0x9d68)
string(0x9f89)
subroutine(0x9f86, "print_bad_string")
subroutine(0x8504, "check_page_is_consistent")
entry(0x9f8f)
...
subroutine(0x9c15, "check_for_percent_token", "check for % and replace with text", "replaces % with the word 'ser'")
...
subroutine(0x90c9, "increment_pointer_over_page_boundary")
...
subroutine(0x9449, "check_for_directory_W", "is the directory W", "Check for directory W, hard coded")
...
subroutine(0x8439, "wipe_variables_from_00_to_8e", "reset some zero page variables", "Wipes some of the zero page variables, but keeps 0x0a and sets 0x31 to &ff", {'x' : "offset for indirect"}, None, False, None, False)
subroutine(0x845b, "populate_prefix_array")
label(0x0436, "prefix_array")
label(0x80c5, "data_table3")
subroutine(0x906f, "increment_another_pointer_over_page_boundary")
subroutine(0x946e, "check_prefix_for_CR_or_period")
subroutine(0x93c6, "error_too_long")
label(0x84b1, "print_space_loop")
label(0x862c, "data_table4")
byte(0x862c,3)
subroutine(0x8ce8, "close_file_by_handle", "close file by handle", "Closed a file specified by the handle in x\n called with values &62, &7c, &6f", {'x' : "Offset from 0x0000 which holds the handle number"}, None, False, None, False)
label(0x7c, "file_handle_3")
label(0x6f, "file_handle_2")
comment(0x8ce6, "output_file_handle", align=Align.INLINE)
label(0x85bc, "jump_to_oswrch")
subroutine(0x8628, "convert_hex_to_digit")
subroutine(0x9363, "check_prefix_length")
subroutine(0x93b4, "print_prefix_text")
comment(0x8f5e, "is bit 6 set", align=Align.INLINE)
label(0x4c4, "file_name")
subroutine(0x8892, "have_file_loaded")
label(0x887a, "reset_stack_pointer")
subroutine(0x8876, "is_there_a_file_loaded")
string(0x9608)
subroutine(0x92c9, "convert_a_reg_to_uppercase", "converts the a reg to upper case if appropriate", "If the A reg is lowercase, change to uppercase", {'a' : "Character to check and convert"}, None, False, None, False)
comment(0x9dea, "string contains space or non-printables", align=Align.INLINE)
subroutine(0x9de4, "check_for_non_printables_and_marker")
subroutine(0x9f48, "add_16bit_number", "adds to a 16 byte number", "Adds to a 16 bit word, offset in x", {'x' : "offset from &0000"}, None, False, None, False)
subroutine(0x8cf0, "jmp_to_osfind")
label(0x8cfd, "close_the_file_we_just_opened")
subroutine(0x8fb1, "store_filename_address_in_pointer2")
subroutine(0x8fa2, "read_bytes_from_file")
subroutine(0x9eff, "check_for_single_character_wildcard")
subroutine(0x9f10, "check_for_wildcard")
comment(0x9fdb, "this looks like colour 0, then colour 1", align=Align.AFTER_LINE)
subroutine(0x8045, "was_that_me")
comment(0x80ac, "get the rom number from the service call", align=Align.INLINE)
subroutine(0x8fc0, "increment_x_by_14_set_y_to_4")
comment(0x9452, "is the directory W?", align=Align.INLINE)
string(0x9459)
subroutine(0x93e3, "copy_input_to_prefix_buffer")
subroutine(0x946d, "check_prefix_for_CR_or_period_after_increment")
